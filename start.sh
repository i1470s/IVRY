...
updater () {
	...
	if hash git 2>/dev/null; then
		...
		git remote add origin https://github.com/i1470s/IVRY-Discord-Bot.git >/dev/null 2>&1
		...
		echo "You do not have git installed. Auto-update is not currently supported" 
