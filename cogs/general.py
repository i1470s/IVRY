...
class General(commands.Cog):   
        ...
        async def about(self, ctx):
                try:
                        ...
                        embed.set_author(name="About IVRY", icon_url=ctx.bot.user.avatar_url)
        ...
        async def donate(self, ctx):
                try:
                        ...
                        embed.set_thumbnail(url=ctx.bot.user.avatar_url)
                        embed.set_author(name="IVRY Donations", icon_url=ctx.bot.user.avatar_url)
        ...
        async def invite(self, ctx):
                try:
                        ...
                        embed.set_thumbnail(url=ctx.bot.user.avatar_url)
                        embed.set_author(name="IVRY Invite", icon_url=ctx.bot.user.avatar_url)
