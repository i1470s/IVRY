...
class General_Commands(commands.Cog):   
        ...
        async def credits(self, ctx):
                try:
                        ...
                        embed.add_field(name='Developers:', value=f'[i1470s#0396](https://ivry.tk)')
                        embed.add_field(name='Contributors:', value=f'[asianmin#2060](https://www.youtube.com/channel/UCWe_MB0vTXLjoXpp7D86ybA)')
                        embed.add_field(name='Librarrys:', value=f'[Discord.py](https://github.com/Rapptz/discord.py)\n[Youtube_dl](https://github.com/ytdl-org/youtube-dl/)')
